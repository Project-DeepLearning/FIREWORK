...
class Dot(object):  # Những chấm theo sau của mỗi viên đạn
...
class BulletFlyUp(object):  # Viên đạn bay lên trước khi nổ
...
class Bullet(object):  # Viên đạn sau khi nổ
...
class FireWork(object):  # Quả pháo hoa
